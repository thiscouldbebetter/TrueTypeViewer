...
class GlyphComposite implements Glyph
{
	childGlyphDatas: GlyphCompositeChildGlyphData[];
	...
	): void
	{
		...
		for (var i = 0; i < childGlyphDatas.length; i++)
		{
			...
			childGlyphData.drawToDisplay
			(
				display, fontHeightInPixels, font, offsetForBaseLines, drawPos
			);
		}
	}
...
class GlyphCompositeChildGlyphData
{
	...
	constructor(glyphIndex: number, offset: Coords)
	{
		this.glyphIndex = glyphIndex;
		this.offset = offset;
	}

	glyphFromFont(font: FontTrueType): Glyph
	{
