...
class GlyphContourFlags {
    constructor(isOnContour, xIsShortVector, yIsShortVector, repeats, xIsSameOrSignIfShort, yIsSameOrSignIfShort, contoursMayOverlap) {
    ...
    static fromByte(flagsAsByte) {
        var returnValue = new GlyphContourFlags(((flagsAsByte & 1) > 0), // isOnContour
    ...
    toByte() {
        var flagsAsByte = (this.isOnContour ? 1 : 0)
